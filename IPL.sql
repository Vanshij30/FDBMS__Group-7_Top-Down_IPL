...
/* Entity Tables */
/* Table 1 */
create table if not exists players (p_id char(4) primary key,
...
/* Table 2 */
create table if not exists players_performance (perf_id char(4) primary key,
                                                matches_no int,
                                                runs int,
...
/* Table 3 */
create table if not exists teams (t_id char(4) primary key,
...
/* Table 4 */
create table if not exists game (matches_id char(3) primary key,
                                 win int DEFAULT(0),
                                 loss int DEFAULT(0)
                                 );
...
/* Table 5 */ 
create table if not exists owner (owner_id char(4) primary key,
...
/* Relationship Tables */
/* Table 6 */
create table if not exists rel_team_owner (t_id char(4) not null,
...
/* Table 7 */
create table if not exists rel_player_team (p_id char(4) not null,                                           
                                            p_name varchar(50) not null,
                                            salary_in_cr float(20) not null,
                                            cap_id char(4),
                                            p_type ENUM('Batsman', 'Bowler', 'Keeper', 'Keeper/Batsman') not null,
...
/* Table 8 */
create table if not exists rel_game_team (matches_id char(3) not null,
                                          t_id char(4) not null,
...
/* Table 9 */                                
create table if not exists rel_player_player_performance (p_id char(4) not null,
                                                          perf_id char(4) not null,
